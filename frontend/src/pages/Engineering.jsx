...
const emptyItemForm = { name: '', costPerUnit: '', minStock: '' };
const emptyStockInForm = { quantity: '', supplier: '', note: '', loggedBy: 'Admin' };
const emptyBorrowForm = { quantity: '', borrower: '', note: '', loggedBy: 'Admin' };
...
export default function Engineering() {
  ...
  async function handleReturn(borrowId) {
    ...
    try {
      await api.post(`/transactions/return/${borrowId}`, {
        note: 'Returned',
        loggedBy: 'Admin',
      });
      fetchActiveBorrows();
